...
# class ReviewDemo(TypedDict):
#     summary : str
#     sentiment : str
#
# structured_model_demo = model.with_structured_output(ReviewDemo)
# response = structured_model_demo.invoke("""
# The Samsung 7 kg top load washing machine is a practical and efficient choice for small households. It offers a great balance between capacity, ease of use, and affordability. While it may lack some of the premium features of high-end models, it delivers solid performance for daily laundry needs. Great for users who want simple, reliable, and fuss-free washing.
# """)
# print(response)
